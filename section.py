...
class Section(wx.adv.Wizard):
    def __init__(self, parent):
        wx.adv.Wizard.__init__(self, parent, -1, title=version)
        self.parent = parent
            ...
            if page is self.page3:
                ...
                if self.methode == "D":
                    ...
                    # si l'isolant est PR
                        ...
                        listF1 = [1.07, 1.04, 1.0, 0.96, 0.93, 0.89, 0.85, 0.80, 0.76, 0.71, 0.65, 0.6, 0.53, 0.46,
                                  0.38]
                        f1 = listF1[tempSelect]
                ...
                # Si autre mode de pose
                    ...
                    # sinon si l'isolant est PR
                        ...
                        listF1 = [1.15, 1.12, 1.08, 1.04, 1.0, 0.94, 0.91, 0.87, 0.82, 0.76, 0.71, 0.65, 0.58, 0.50,
                                  0.41]
                        f1 = listF1[tempSelect]
