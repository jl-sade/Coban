...
class Principale(wx.Frame):
    ...
    def __init__(self, titre):
        ...
        try:
            ...
            try:
                ...
                wx.MessageBox(u"Vous n'avez pas les droits nécessaires pour écrire dans le dossier :\n%s\n\n"
                              ...
                              u"http://sg-logiciels.fr pour plus d'informations)." % (
                              os.getcwd(), os.path.join(os.getcwd(), fichierConf)),
                              u'Erreur !',
                              wx.ICON_WARNING)
                self.cheminParDef = os.path.join(os.path.expanduser('~'), '.coban')
        ...
        self.menuModule.Append(-1, u"Électricité", self.sousMenuCalcul)
        ...
        self.menuModule.Append(-1, u"Conversions", self.sousMenuConv)
        self.menuModule.AppendSeparator()
        ...
        self.menuModule.Append(-1, u"Sono / Vidéo", self.sousMenuSonoVideo)
        self.menuModule.AppendSeparator()
        ...
        self.menuModule.Append(-1, u"Chauffage/Climatisation", self.sousMenuClimatic)
        self.menuModule.AppendSeparator()
        ...
        self.menuModule.Append(-1, u"Éclairage", self.sousMenuEclairage)
        self.menuModule.AppendSeparator()
        ...
        self.menuPreferencesSauvegarde = self.menuPreferences.Append(-1, u"Répertoire de sauvegarde",
                                                                     u"Choix du répertoire de sauvegarde")
        self.Bind(wx.EVT_MENU, self.onPreferencesSauvegarde, self.menuPreferencesSauvegarde)
        # Mises à jour auto
        self.menuMaJauto = self.menuPreferences.Append(-1, u"Prévenir des mise à jour",
                                                       u"Prévenir des mise à jour automatiquement", wx.ITEM_CHECK)
        self.menuMaJauto.Check(self.Maj)
        self.Bind(wx.EVT_MENU, self.onMaJ, self.menuMaJauto)

        menuAide.Append(wx.ID_PREFERENCES, u"Préférences", self.menuPreferences)
        ...
        self.btnSection.SetToolTip(u"calcul de section de câble")
        ...
        self.btnChute.SetToolTip(u"calcul de chutes de tension")
        self.Bind(wx.EVT_BUTTON, self.onChute, self.btnChute)

        # bouton Conversions
        self.btnConv = wx.Button(panel, -1, "Conversions", size=colSize)
        self.btnConv.SetToolTip(u"Convertir Watts en Ampères, CV et HP...")
        ...
        if val == wx.ID_OK:
            ...
            try:
                ...
                wx.MessageBox(u"Vous n'avez pas les droits nécessaires pour écrire dans le dossier :\n%s\n\n"
                              ...
                              u"ou modifiez manuellement le fichier :\n%s\n\n"
                              u"(consultez l'aide de Coban ou le site\n"
                              u"http://www.sg-logiciels.fr pour plus d'informations)." % (
                              os.getcwd(), os.path.join(os.getcwd(), fichierConf)),
                              u'Erreur !',
                              wx.ICON_WARNING)
                dlg.Destroy()
